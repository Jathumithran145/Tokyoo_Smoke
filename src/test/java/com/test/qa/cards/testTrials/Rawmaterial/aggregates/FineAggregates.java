...
public class FineAggregates extends TestBase {
    ...
    public void WaterAbsorbtion() throws Exception {
        ...
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/a[1]/div");    //Aggregate
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/a[1]/div");    //FIne Aggregates
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/a[1]/div");    //Water Abstraction Test
        PageBase.staticWait(3);
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/div/div/div/div[1]/div"),"Incoming sample table is displayed");
        ...
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[1]/div[1]"),"Water absroption  table is displayed");
        MethodBase.click_ByXpath("//*[@id=\"date\"]/div/input");   //Date
        PageBase.hitEnter();
        PageBase.staticWait(5);
        MethodBase.click_ByXpath("//*[@id=\"material_state\"]/div/div/div");    //Material State
        MethodBase.hitEnter();
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"test_level\"]/div/div");    //Test Level
        PageBase.hitEnter();

        MethodBase.click_ByXpath("/html/body/div[1]/div/section/section/main/div/div/div[1]/div[2]/div[1]/div[5]/div/div[1]/div[1]/span[1]");   //No of Trial
        Thread.sleep(2000);
        MethodBase.click_ByXpath("/html/body/div[1]/div/section/section/main/div/div/div[1]/div[2]/div[1]/div[5]/div/div[1]/div[1]/span[1]");   //No of Trial
        Thread.sleep(2000);
        PageBase.staticWait(5);

        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[1]/div[2]/div[2]/div/div/button");    //Submit btn
        Thread.sleep(2000);
    ...
    public void MicronTest() throws Exception {
        ...
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/a[1]/div");    //FIne Aggregates
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/a[2]/div");    //Micron Test
        PageBase.staticWait(3);
        ...
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[1]/h3"),"Test trial table is displayed");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[1]/input","744");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[2]/input","244");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[5]/input","500");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[3]/input","713.2");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[5]/input","469.2");
        Thread.sleep(2000);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/button"); //Trial
        ...
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[2]/input","244");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[1]/input","500");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[4]/input","708.8");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[5]/input","464.8");
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/button"); //Trial
    ...
    public void AggregateImpactValueTest() throws Exception {
        ...
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/a[1]/div");    //FIne Aggregates
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/a[3]/div");    //Aggregate Impact Value Test
        PageBase.staticWait(3);
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/div/div/div/div[1]/div"), "Incomming sample table is not Displayed");
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div/div/div/div/div[2]/div/table/tbody/tr[1]/td[8]");  //Create Test
        PageBase.staticWait(3);
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[1]/div[1]/div/div[1]/div/h4"), "Aggregate Impact Value test table is displayed");
        MethodBase.click_ByXpath("//*[@id=\"date\"]/div");  //Date
        PageBase.hitEnter();
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"material_state\"]/div/div");    //Metrial State
        ...
        //First Trial
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[1]/h3"),"Test trial table is displayed");
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[2]/input","646");
        PageBase.staticWait(5);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[3]/input","309.9");
        PageBase.staticWait(5);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[4]/input","82.1");
        PageBase.staticWait(3);
        Thread.sleep(2000);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/button"); //Trial
        //Second Trial
        ...
        softAssert.assertTrue(MethodBase.isDisplayed_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[1]/h3"),"Test trial table is displayed");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[2]/input","309.9");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[3]/input","336.5");
        PageBase.staticWait(3);
        MethodBase.setText_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/div[4]/input","82.1");
        PageBase.staticWait(3);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div[1]/div/div[2]/div/button"); //Trial
