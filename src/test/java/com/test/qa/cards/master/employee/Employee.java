...
public class Employee extends TestBase {
    ...
    public static void  addemployeeSmokeTest() throws Exception {
        ...
        Validation Checking
         */
        MethodBase.setText_ByID("first_name","Hanna");//first_name
        MethodBase.setText_ByID("last_name","Nanthu");//last_name
        MethodBase.setText_ByID("address","Negamobo");//address
        MethodBase.setText_ByID("phoneno","0778967896");//phoneno
        MethodBase.setText_ByID("email","Hanna@gmail.com");//email
        ...
        Data Input
         */
        MethodBase.setText_ByID("first_name","Han");//first_name
        MethodBase.setText_ByID("last_name","Nanthukumar");//last_name
        MethodBase.setText_ByID("address","Negamobo");//address
        MethodBase.setText_ByID("phoneno","0778967896");//phoneno
        MethodBase.setText_ByID("email","Han@gmail.com");//email
        PageBase.staticWait(5);
        MethodBase.click_ByXpath("//*[@id=\"plant\"]/div/div");//clickPlantOption
        PageBase.staticWait(5);
        MethodBase.click_ByXpath("//*[@id=\"desigination\"]/div/div");//selectDesignationOptioN
    ...
    public  static  void  editemployeeSmokeTest() throws Exception {
        ...
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div[2]/div/div/div/div/div[2]/div/table/tbody/tr[6]/td[11]/span/a[1]/i");// edit button
