...
To Check validation
    ...
    Data Input
        ...
        */
            ...
            MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div[1]/div[5]/div[1]");//unit field
            PageBase.staticWait(5);
            MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div[2]/div/div/div/div[2]/div/table/tbody/tr[7]/td[3]/span/a[1]/i");//Click edit icon
            MethodBase.clear_ByXpath("//*[@id=\"unit_name\"]","xl");// clear existing data
            PageBase.staticWait(5);
//            MethodBase.click_ByXpath("//*[@style=\"background: rgb(0, 19, 40); color: white; border: none;\"]");//save
