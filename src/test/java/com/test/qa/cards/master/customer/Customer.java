...
//        MethodBase.click_ByXpath("//span[text()=\"OK\"]");
    ...
    public static void editcustomerSmokeTest() throws Exception {
        ...
        PageBase.staticWait(5);
        MethodBase.click_ByXpath("//*[@id=\"root\"]/div/section/section/main/div/div[2]/div/div/div/div[2]/div/table/tbody/tr[1]/td[9]/span/a[1]/i");
        MethodBase.clear_ByXpath("//*[@id=\"customer_name\"]","dem");
        MethodBase.clear_ByXpath("//*[@id=\"customer_email\"]","demon@gmai.com");
